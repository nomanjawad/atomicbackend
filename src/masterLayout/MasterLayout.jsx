...
const MasterLayout = ({ children }) => {
  ...
  let [featureNotAvailable, setFeatureNotAvailable] = useState(false)
      ...
      >
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            {/* SEO Scripts Dropdown */}
            <li className="dropdown">
              <Link to="#">
                <Icon icon="mdi:script-text-outline" className="menu-icon" />
            ...
            {/* Forms Dropdown - Disabled */}
            <li className="sidebar-menu-item" style={{ opacity: 0.6 }}>
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); setFeatureNotAvailable(true); }}
                style={{ cursor: 'pointer' }}
              >
                <Icon icon="heroicons:document" className="menu-icon" />
                <span>Forms</span>
                <span className="badge bg-secondary ms-auto" style={{ fontSize: '10px' }}>Soon</span>
              </a>
            </li>

            {/* Table Dropdown - Disabled */}
            <li className="sidebar-menu-item" style={{ opacity: 0.6 }}>
              <a
                href="#"
                onClick={(e) => { e.preventDefault(); setFeatureNotAvailable(true); }}
            ...
            {/* Users Dropdown - MOVED to after Dashboard
            <li className="dropdown">
              <Link to="#">
                <Icon
                  icon="flowbite:users-group-outline"
            ...
            {/* Role & Access Dropdown - MOVED to after Dashboard
            <li className="dropdown">
              <Link to="#">
                <i className="ri-user-settings-line" />
                <span>Role &amp; Access</span>
            ...
            {/* Blog Posts Dropdown - MOVED to after Dashboard
            <li className="dropdown">
              <Link to="#">
                <Icon icon="heroicons:document-text" className="menu-icon" />
                <span>Blog Posts</span>
      ...
      >
        ...
        <footer className="d-footer">
          <div className="row align-items-center justify-content-between">
            <div className="col-auto">
              <p className="mb-0">
                © 2025 SkyTech Solution. All Rights Reserved.
              </p>
            </div>
            <div className="col-auto">
              <p className="mb-0">
                Made by <span className="text-primary-600">Marketorr</span>
              </p>
            </div>
          </div>
        </footer>
        ...
        >
          ...
          >
            <div style={{
              ...
              <Icon icon="mdi:tools" width="28" style={{ color: '#5c6bc0' }} />
            </div>
            ...
            <p style={{
              ...
              This feature is not available right now. Once available, it will appear here.
            </p>
